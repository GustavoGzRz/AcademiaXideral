...
public class StudentControllerServlet extends HttpServlet {
	...
	private void updateStudent(HttpServletRequest request, HttpServletResponse response)
		...
		int credential = Integer.parseInt(request.getParameter("credential"));
		String status = request.getParameter("status");
		
		// create a new student object
		Student theStudent = new Student(id, firstName, lastName, email, credential, status);
	...
	private void addStudent(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// create a new student object
		Student theStudent = new Student(firstName, lastName, email,credential, status);
